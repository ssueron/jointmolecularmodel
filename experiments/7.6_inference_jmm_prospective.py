...
if __name__ == '__main__':
    ...
    MODEL = JMM
    EXPERIMENT_NAME = "jmm_library_inference_prospective"
    BEST_MLPS_ROOT_PATH = f"/projects/prjs1021/JointChemicalModel/results/smiles_mlp_prospective"
    JMM_ROOT_PATH = f"/projects/prjs1021/JointChemicalModel/results/smiles_jmm_prospective"
    ...
    libraries = {'asinex': library_asinex,
                 'enamine': library_enamine_hit_locator,
                 'specs': library_specs}
    ...
    for library_name, library in libraries.items():
        ...
        for seed in seeds:
            ...
            try:
                ...
                train_dataset, val_dataset = load_data_for_seed(dataset_name, seed)
