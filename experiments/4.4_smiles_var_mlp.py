""" Perform hyperparameter tuning and model training for an SMILES + Variational layer + MLP control model
...
from jmm.models import SmilesMLP
from jmm.callbacks import mlp_callback


def write_job_script(dataset_names: list[str], out_paths: list[str] = 'results', experiment_name: str = "smiles_var_mlp",
                     experiment_script: str = "4.4_smiles_var_mlp.py", partition: str = 'gpu', ntasks: str = '18',
...
if __name__ == '__main__':
    ...
    EXPERIMENT_NAME = "smiles_var_mlp"
