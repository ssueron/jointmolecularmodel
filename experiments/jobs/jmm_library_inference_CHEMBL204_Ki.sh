#!/bin/bash
#SBATCH --job-name=jmm_library_inference_CHEMBL204_Ki
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/jmm_library_inference_CHEMBL204_Ki.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
