        ...
        if 'ChEMBL_33' not in dataset:
            ...
            for seed in seeds:
                try:
                    ...
                    all_results.append(df_enamine_screening_collection)

                    pd.concat(all_results).to_csv(ospj(JMM_ROOT_PATH, dataset, '_enamine_screening_collection_inference.csv'), index=False)
