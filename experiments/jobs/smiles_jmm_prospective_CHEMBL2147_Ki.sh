#!/bin/bash
#SBATCH --job-name=smiles_jmm_prospective_CHEMBL2147_Ki
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/smiles_jmm_prospective_CHEMBL2147_Ki.out
#SBATCH -p gpu_a100
#SBATCH -N 1
#SBATCH --ntasks=18
