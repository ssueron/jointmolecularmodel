#!/bin/bash
#SBATCH --job-name=jmm_library_inference_CHEMBL3979_EC50
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/jmm_library_inference_CHEMBL3979_EC50.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
